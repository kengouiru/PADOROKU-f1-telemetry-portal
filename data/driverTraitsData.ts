...
export const DRIVER_TRAIT_ASSIGNMENTS: Record<string, DriverTraitId[]> = {
  ...
  MSC: ['CLEAN_AIR_DEMON', 'RAIN_DEITY', 'SUB_2S_PIT_CREW'],
  SCH: ['CLEAN_AIR_DEMON', 'RAIN_DEITY', 'SUB_2S_PIT_CREW'],
  VET: ['SATURDAY_MAGICIAN', 'CLEAN_AIR_DEMON', 'CLUTCH_COMEBACK', 'LAUNCH_MASTER'],
  RAI: ['ICE_COLD_HEART', 'TYRE_WHISPERER', 'SMOOTH_OPERATOR'],
  MAN: ['LATE_BRAKER', 'MAD_MAX_HUNT', 'CLUTCH_COMEBACK'],
  HAK: ['ICE_COLD_HEART', 'SATURDAY_MAGICIAN', 'CLEAN_AIR_DEMON'],
  LAU: ['TYRE_WHISPERER', 'SMOOTH_OPERATOR', 'CLEAN_AIR_DEMON'],
  RIC: ['LATE_BRAKER', 'STREET_FIGHTER', 'CLUTCH_COMEBACK'],
};
