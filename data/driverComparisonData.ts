...
export const DRIVER_SKILL_RATINGS: Record<string, DriverSkills> = {
  ...
  VET: { qualifying: 96, racePace: 97, tyreManagement: 94, wetWeather: 95, overtaking: 92, consistency: 93 },
  RAI: { qualifying: 94, racePace: 97, tyreManagement: 98, wetWeather: 93, overtaking: 95, consistency: 94 },
  MAN: { qualifying: 97, racePace: 98, tyreManagement: 90, wetWeather: 92, overtaking: 99, consistency: 88 },
  HAK: { qualifying: 98, racePace: 97, tyreManagement: 93, wetWeather: 92, overtaking: 96, consistency: 94 },
  LAU: { qualifying: 93, racePace: 98, tyreManagement: 99, wetWeather: 89, overtaking: 91, consistency: 99 },
};
...
export const TEAMMATE_HEAD_TO_HEAD_DATA: TeammateHeadToHead[] = [
  ...
  },
  {
    ...
    qualiScore: [68, 26],
    raceScore: [65, 29],
    pointsScore: [1433, 978.5],
    summary: 'ベッテルが4年連続ワールドチャンピオンを獲得したレッドブル黄金期。2010年トルコGPの同士討ちや2013年マレーシアGPの「Multi 21」など火花を散らした名タッグ。',
  },
  {
    driver1Code: 'RAI',
    driver2Code: 'MAS',
    ...
    raceScore: [24, 21],
    pointsScore: [207, 194],
    summary: '2007年にライコネンがワールドチャンピオンを獲得し、2008年にはマッサが1ポイント差の王座争いを演じた、スクーデリア・フェラーリ最後の黄金期を支えた強力タッグ。',
  },
  {
    driver1Code: 'LAU',
    driver2Code: 'PRO',
    teamName: 'McLaren TAG Porsche',
    years: '1984 - 1985',
    racesCount: 32,
    qualiScore: [2, 30],
    raceScore: [9, 13],
    pointsScore: [86, 144.5],
    summary: '1984年に史上最小のわずか「0.5ポイント差」でラウダがプロストを下し王座戴冠。予選スピードのプロストに対し、百戦錬磨のラウダが決勝レースペースで対抗した頭脳戦の極致。',
  },
  {
    driver1Code: 'MAN',
    driver2Code: 'PIQ',
    teamName: 'Williams Honda',
    years: '1986 - 1987',
    racesCount: 32,
    qualiScore: [16, 16],
    raceScore: [14, 11],
    pointsScore: [131, 142],
    summary: '最強ホンダV6ターボを搭載したウィリアムズで激突した英・伯の意地とプライド。ピケの計算し尽くされた戦略眼に対し、マンセルの鬼神の突っ込みと豪腕が真っ向勝負。',
  },
];
...
export const DRIVER_RIVALRY_MAPPING: Record<string, string> = {
  ...
  'HAM-VET': 'hamilton-vs-vettel',
  'VET-HAM': 'hamilton-vs-vettel',
  'MSC-HAK': 'schumacher-vs-hakkinen',
  'HAK-MSC': 'schumacher-vs-hakkinen',
  'RAI-ALO': 'raikkonen-vs-alonso',
  'ALO-RAI': 'raikkonen-vs-alonso',
  'LAU-PRO': 'lauda-vs-prost',
  'PRO-LAU': 'lauda-vs-prost',
  'VER-SEN': 'verstappen-vs-senna',
  'SEN-VER': 'verstappen-vs-senna',
};
