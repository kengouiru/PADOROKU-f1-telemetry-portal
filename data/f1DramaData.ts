...
export const SEASON_STORYLINES: SeasonStoryline[] = [
  {
    id: 'season-2026-new-regulations-eleventh-team',
    seasonYear: '2026',
    category: 'contemporary',
    title: '2026シーズン「新時代・11チーム狂詩曲」',
    subtitle: '350kW電動化・アクティブ空力・キャデラック参戦でリセットされた世界秩序',
    tagline: 'パワーユニット完全刷新、アクティブエアロ解禁。第11のチーム降臨で幕を開けた激動の2026年。',
    overview:
      'MGU-Hの廃止とMGU-K出力3倍（350kW）という歴史的PU新規定、アクティブストレートモード空力の導入、そして米GMキャデラックの第11番目新規参戦。メルセデス2年目の19歳キミ・アントネッリが開幕から怒涛の6勝で首位に立ち、フェラーリ移籍2年目のハミルトン、王座奪還を期すフェルスタッペン、ホンダ×ニューウェイのアストンマーティンが激しく火花を散らす。',
    chapters: [
      {
        chapterNumber: 1,
        title: '新規定開幕 — 350kWハイブリッドショック',
        races: '第1戦オーストラリアGP 〜 第4戦バーレーンGP',
        story:
          '開幕戦アルバートパークで全車が一斉に新規定マシンを投入。ストレートでのアクティブ空力展開と超強力な電動回生により、従来のレーシングラインが一変。メルセデスPU「M17」の圧倒的な電気エネルギー管理が火を吹き、キミ・アントネッリが史上最年少クラスの開幕連勝を達成してパドックを震撼させた。',
        pivotalMoment: '開幕戦のストレートでアクティブウイングを展開し、圧倒的なトップスピードでオーバーテイクを決めるアントネッリ。',
        radioOrQuote: '🎙️ トト・ヴォルフ: 「キミ、これが新時代のベンチマークだ。君が歴史を作っている」',
      },
      {
        chapterNumber: 2,
        title: '第11の巨頭 — キャデラックの意地とアウディの挑戦',
        races: '第5戦サウジアラビアGP 〜 第8戦モナコGP',
        story:
          '第11チームとして参入したキャデラックは、ペレスとボッタスの熟練コンビが手堅くマシンを開発し、マイアミでチーム史上初のポイントを獲得してアメリカ中を沸かせた。一方アウディは内製ワークスPUの信頼性を急速に向上させ、ヒュルケンベルグがモナコでQ3進出の快挙を成し遂げる。',
        pivotalMoment: 'マイアミGPでペレスがチェッカーを受け、キャデラックF1初の入賞ポイントを掴み取った瞬間。',
        radioOrQuote: '🎙️ ペレス: 「キャデラックの全員、よくやった！ここから僕たちの歴史が始まるんだ！」',
      },
      {
        chapterNumber: 3,
        title: '夏の熱闘 — マドリード初開催と三つ巴の死闘',
        races: '第9戦カナダGP 〜 第16戦マドリードGP',
        story:
          'シルバーストーンではハミルトンがフェラーリ移籍後初となる感動のイギリスGP制覇。そして9月、F1カレンダーに初登場したマドリード市街地サーキット。トリッキーな低速セクションと超高速ストレートでアントネッリ、ラッセル、フェルスタッペン、ハミルトンが0.1秒を争う歴史的バトルを展開した。',
        pivotalMoment: '初開催マドリードGPの最終コーナー、インを刺して首位を守り抜いたアントネッリの超絶ブレーキング。',
        radioOrQuote: '🎙️ アントネッリ: 「信じられない！マドリードを制したぞ！みんな、本当に誇りに思う！」',
      },
    ],
    champion: 'シーズン進行中 (首位: K.アントネッリ 267pt / 第16戦マドリード終了時点)',
    constructorsChampion: 'シーズン進行中 (首位: Mercedes-AMG 468pt / 第16戦マドリード終了時点)',
    aftermath:
      '11チーム22名による新規定の覇権争いは、新世代スターのアントネッリがリードしつつも、フェラーリ、マクラーレン、レッドブル、そしてホンダ×ニューウェイのアストンマーティンが猛追する空前の大乱戦となっている。',
  },
  {
...
export const RIVALRIES: Rivalry[] = [
  ...
  {
    id: 'tsunoda-vs-lawson',
    type: 'current',
    name: '角田裕毅 vs リアム・ローソン',
    subtitle: 'レッドブル昇格の唯一の切符を争う、若手育成アカデミー最大の決闘',
    driver1: {
      name: '角田裕毅',
      code: 'TSU',
    ...
    nature: 'リカルド離脱後のRBで直接対決を迎えた二人。F1での実績と爆発的スピードを誇る角田に対し、代役時から卓越した勝負強さを見せるローソンの社内直接対決。',
    definingMoment:
      '2024年アメリカGP〜サンパウロGP：復帰戦から激しい中団ポイント争いを演じ、互いにコース上で1インチも引かないサイド・バイ・サイドを展開。',
    h2hSummary: '予選一発では角田がリードを保ち、レース戦略と混乱への対応力でローソンが食らいつく、次期レッドブルシートを賭けた真剣勝負。',
    quote: '「リアムが速いドライバーなのは分かっている。でも僕が倒さなければならない相手であることに変わりはない。」— 角田裕毅',
  },
  {
    id: 'alonso-vs-hamilton',
    type: 'historic',
    name: 'フェルナンド・アロンソ vs ルイス・ハミルトン',
    subtitle: '2007年の激震から20年。今もコース上で最高のリスペクトを交わす宿敵',
    driver1: {
      name: 'フェルナンド・アロンソ',
      code: 'ALO',
      team: 'Aston Martin',
    ...
    driver2: {
      name: 'ルイス・ハミルトン',
      code: 'HAM',
      team: 'Ferrari (元McLaren/Mercedes)',
      titles: 7,
      color: '#E80020',
    },
    nature: '2007年マクラーレンでの激しい内戦（ハンガリーピットストップ事件）を経て、互いの卓越したドライビング能力を誰よりも認め合う特別なライバル関係。',
    definingMoment:
      '2021年ハンガリーGPでの10周に及ぶ伝説の攻防。そして2023年バーレーンGPターン10でのアロンソの芸術的イン差しオーバーテイク。',
    h2hSummary: '通算対戦数でF1歴代最多クラス。二人合わせて9度の世界王座、130勝以上の勝利を誇るモータースポーツ界の至宝対決。',
    quote: '「コース上でルイスと戦う時、いつも格別の興奮がある。彼はフェアであり、同時に最もタフな相手だ。」— フェルナンド・アロンソ',
  },
];
...
export const DRAMATIC_MOMENTS: DramaticMoment[] = [
  ...
  {
    id: 'schumacher-3stops-1998',
    title: '「ミハエル・シューマッハとロス・ブラウンの伝説の3ストップ大作戦」',
    grandPrix: '1998年 ハンガリーGP (ハンガロリンク)',
    year: 1998,
    hero: 'ミハエル・シューマッハ ＆ ロス・ブラウン',
    team: 'Scuderia Ferrari',
    badge: 'F1戦略史上最大の奇策',
    radioQuote: '🎙️ ロス・ブラウン: 「ミハエル、25秒のギャップを作るのに残り19周ある。お前の予選アタックラップを19周連続で見せてくれ。」',
    radioSpeaker: 'Ross Brawn (Technical Director)',
    story:
      'コース上でマクラーレン（ハッキネン＆クルサード）を抜けないと判断したフェラーリの戦略家ロス・ブラウンは、突如「3ストップ作戦」への変更を決断。シューマッハに対し「ピットアウト後に25秒のギャップを作るため、毎周予選アタックのペースで走れ」と指示。シューマッハは異次元のファステストラップを連発し、見事マクラーレン勢の前でピットアウトして歴史的勝利を飾った。',
    outcome: 'フェラーリ M.シューマッハ優勝（マクラーレンを戦略と超絶ドライビングで完全粉砕）',
    aftermath: '「ドライバーと戦略家の絶対的信頼が生んだF1史上最高の勝利」として、全チームの戦略構築の教科書となった伝説の一戦。',
    tag: '戦略の極致',
  },
  {
    id: 'button-canada-miracle-2011',
    title: '「ジェンソン・バトン、最後尾からの6回ピット・4時間超の大逆転劇」',
    grandPrix: '2011年 カナダGP (ジル・ヴィルヌーヴ)',
    year: 2011,
    hero: 'ジェンソン・バトン',
    team: 'McLaren',
    badge: 'F1史上最長レースの奇跡',
    radioQuote: '🎙️ バトン: 「今スリックタイヤに替えるのが絶対に正解だ。ものすごいグリップがある！」',
    radioSpeaker: 'Jenson Button (McLaren)',
    story:
      '豪雨による2時間の中断、チームメイトとの接触、ドライブスルーペナルティ、パンクなどにより一時最下位（P21）まで転落したバトン。しかし路面が乾きゆく中で誰よりも早くインターミディエイト、ドライタイヤへのスイッチを決断。驚異的なペースで全車をゴボウ抜きし、最終ラップのターン6でトップのベッテルにプレッシャーをかけてミスを誘発し劇的な逆転優勝を果たした。',
    outcome: 'マクラーレン J.バトン優勝（F1史上最長時間レース 4時間4分39秒を制覇）',
    aftermath: 'ウェットとドライの境目を見極めるバトンの天才的タイヤセンスが世界を震撼させた伝説のレース。',
    tag: '雨の魔術師',
  },
  {
    id: 'verstappen-abudhabi-final-lap-2021',
    title: '「2021年 最終戦アブダビGP — ファイナルラップの歴史的死闘」',
    grandPrix: '2021年 アブダビGP (ヤス・マリーナ)',
    year: 2021,
    hero: 'マックス・フェルスタッペン ＆ ルイス・ハミルトン',
    team: 'Red Bull Racing / Mercedes',
    badge: '同点で迎えた運命の最終周',
    radioQuote: '🎙️ ホーナー: 「MAX VERSTAPPEN! YOU ARE THE WORLD CHAMPION! THE WORLD CHAMPION!」',
    radioSpeaker: 'Christian Horner (Red Bull Racing)',
    story:
      'シーズン全22戦を戦い抜き、フェルスタッペンとハミルトンが全くの同ポイントで迎えた最終決戦。レース終盤ラティフィのクラッシュによりセーフティカーが導入。レッドブルは新品ソフトタイヤへのギャンブルピットを敢行し、ステイアウトしたハミルトン（摩耗したハード）との最終周スプリント勝負に持ち込み、ターン5で劇的オーバーテイクを決めて悲願の初タイトルを獲得した。',
    outcome: 'レッドブル M.フェルスタッペン優勝＆初の世界王者戴冠',
    aftermath: '新旧の王者が激突した世紀の対決。現代F1人気が世界的に大爆発する契機となった歴史的事件。',
    tag: '世紀の戴冠',
  },
];
...
export const PADDOCK_DYNAMICS: PaddockRelationship[] = [
  {
    id: 'redbull-mekies-max',
    category: 'principal',
    title: 'レッドブル新時代：メキース新代表とフォード新規定の舵取り',
    description: 'ホーナー退任後、レーシング・ブルズから昇格したローラン・メキース代表＆CEOが就任。マルコ顧問、王者フェルスタッペン、そして新PU「Red Bull Ford Powertrains」の統合を指揮する。',
    members: [
      { name: 'ローラン・メキース', code: 'MEK', role: 'チーム代表兼CEO' },
      { name: 'ヘルムート・マルコ', code: 'MAR', role: 'モータースポーツ顧問' },
      { name: 'マックス・フェルスタッペン', code: 'VER', role: '4冠の世界王者' },
      { name: 'イサック・ハジャー', code: 'HAD', role: '2026昇格の新鋭' },
    ],
    dynamics: '新PU規定元年という最大の転換期に、技術畑出身のメキース代表がチームの結束を再構築。フェルスタッペンとの信頼関係構築が至上命題。',
    badgeColor: '#3671C6',
  },
  {
    id: 'aston-martin-newey-honda',
    category: 'principal',
    title: 'アストンマーティン覚醒：ニューウェイ代表＆ホンダ完全ワークス体制',
    description: '鬼才エイドリアン・ニューウェイがマネージング・テクニカルパートナー兼チーム代表に就任。アンディ・コーウェルCEOとともに、ホンダの完全ワークスPU「RA626H」を独占搭載。',
    members: [
      { name: 'エイドリアン・ニューウェイ', code: 'NEW', role: 'マネージング・テクニカルパートナー兼代表' },
      { name: 'アンディ・コーウェル', code: 'COW', role: 'グループCEO' },
      { name: 'フェルナンド・アロンソ', code: 'ALO', role: '歴戦の闘将' },
    ],
    dynamics: 'F1史上最強の空力設計者ニューウェイと元メルセデスPUの重鎮コーウェル、そしてホンダの技術が融合。アロンソの悲願である通算33勝目とタイトル獲得へ向けた全方位シフト。',
    badgeColor: '#229971',
  },
  {
    id: 'cadillac-budkowski-veterans',
    category: 'principal',
    title: 'キャデラックF1参入：バドコウスキー代表と実力派ベテランの初陣',
    description: 'F1第11番目の新規コンストラクターとして電撃参入を果たした米ゼネラルモーターズ（GM）/キャデラック。マーチン・バドコウスキー代表の指揮下、ペレス＆ボッタスのベテランコンビが走る。',
    members: [
      { name: 'マーチン・バドコウスキー', code: 'BUD', role: 'チーム代表' },
      { name: 'セルジオ・ペレス', code: 'PER', role: '初代エースドライバー' },
      { name: 'バルテリ・ボッタス', code: 'BOT', role: '初代エースドライバー' },
    ],
    dynamics: '通算16勝を誇るベテラン2名が、創設初年度の新規チームに不可欠な精密テレメトリーフィードバックとセットアップの方向性を注入。2028年自社GM製PU投入に向けた基盤構築。',
    badgeColor: '#D4AF37',
  },
  {
    id: 'audi-binotto-works',
    category: 'principal',
    title: 'アウディ本格ワークス参戦：ビノット代表とドイツ巨頭の野望',
    description: 'ザウバーを完全買収した独アウディがF1フルワークス参戦を開始。元フェラーリ代表のマッティア・ビノット（COO/CTO兼代表）がノイブルクとヒンウィルの中枢を掌握。',
    members: [
      { name: 'マッティア・ビノット', code: 'BIN', role: 'COO/CTO兼チーム代表' },
      { name: 'ニコ・ヒュルケンベルグ', code: 'HUL', role: 'ドイツ人初代ワークスエース' },
      { name: 'ガブリエル・ボルトレート', code: 'BOR', role: 'F3・F2王者ルーキー' },
    ],
    dynamics: '内製ワークスパワーユニット「Audi Works E-Performance」の信頼性とヒンウィル風洞の空力開発を加速。堅実なヒュルケンベルグと若きボルトレートの育成を同時進行。',
    badgeColor: '#e0001a',
  },
  {
    ...
    members: [
      ...
      { name: 'ルイス・ハミルトン', code: 'HAM', role: 'フェラーリ2年目の7冠王者' },
    ],
  ...
  },
  {
    ...
    members: [
      { name: '角田裕毅', code: 'TSU', role: '参戦6年目を迎えたRBのエース' },
      { name: 'リアム・ローソン', code: 'LAW', role: 'レッドブル昇格を果たした実力派' },
      { name: 'イサック・ハジャー', code: 'HAD', role: '2026年にレッドブル本隊へ昇格' },
    ],
