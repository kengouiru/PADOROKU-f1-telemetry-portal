...
export const SEASON_STORYLINES: SeasonStoryline[] = [
  {
    ...
    overview:
      'MGU-Hの廃止とMGU-K出力3倍（350kW）という歴史的PU新規定、アクティブストレートモード空力の導入、そして米GMキャデラックの第11番目新規参戦。メルセデス2年目の19歳キミ・アントネッリが怒涛の8勝を挙げて選手権首位（292pt）に立ち、チームメイトのラッセル（2勝 211pt）、フェラーリのハミルトン（1勝）とルクレール（1勝）、マクラーレンのノリス（2勝）が猛追する。',
    chapters: [
      {
        chapterNumber: 1,
        title: '新規定開幕 — 350kWハイブリッドショック',
        races: '第1戦オーストラリアGP 〜 第3戦日本GP',
        story:
          '開幕戦アルバートパークではジョージ・ラッセルが新規定初勝利。続く中国・上海と鈴鹿でキミ・アントネッリが連勝を飾り、メルセデスPU「M17」の圧倒的な電気エネルギー管理とアントネッリの卓越した回生マネジメントがパドックを震撼させた。',
        pivotalMoment: '鈴鹿の130Rでアクティブウイングを展開し、鮮やかに首位を奪取したアントネッリのスーパーオーバーテイク。',
        radioOrQuote: '🎙️ トト・ヴォルフ: 「キミ、これが新時代のベンチマークだ。君が歴史を作っている」',
      },
      {
        chapterNumber: 2,
        title: '第11の巨頭 — キャデラックの挑戦と群雄割拠',
        races: '第4戦マイアミGP 〜 第8戦オーストリアGP',
        story:
          '第11チームとして参入したキャデラックは、ペレスとボッタスの熟練コンビが懸命に初期開発を推進。一方アウディはヒュルケンベルグとボルトレートが貴重な入賞を果たし、モナコではアントネッリが母国フェラーリ勢を退けて歴史的勝利を飾る。',
        pivotalMoment: 'モナコのラスカスを完璧にクリアし、チーム無線で絶叫するアントネッリのモナコ初制覇。',
        radioOrQuote: '🎙️ アントネッリ: 「モナコで勝った！信じられない、みんな夢が叶ったよ！」',
      },
      {
        chapterNumber: 3,
        title: '夏の熱闘 — マドリード初開催と三つ巴の死闘',
        races: '第9戦イギリスGP 〜 第14戦マドリードGP',
        story:
          'バルセロナでハミルトンがフェラーリ移籍後初勝利を掴み、シルバーストーンではルクレールが制覇。そして9月、新設されたマドリード市街地サーキットでアントネッリがフェルスタッペンとの激闘を制して今季8勝目をマークした。',
        pivotalMoment: '初開催マドリードGPの最終コーナー、インを刺して首位を守り抜いたアントネッリの超絶ブレーキング。',
        radioOrQuote: '🎙️ アントネッリ: 「信じられない！マドリードを制したぞ！みんな、本当に誇りに思う！」',
      },
    ],
    champion: 'シーズン進行中 (首位: K.アントネッリ 292pt / 第14戦マドリード終了時点)',
    constructorsChampion: 'シーズン進行中 (首位: Mercedes-AMG 503pt / 第14戦マドリード終了時点)',
    aftermath:
