...
export const { handlers, signIn, signOut, auth } = NextAuth({
  providers: [
    ...
    Credentials({
      ...
      async authorize(credentials) {
        ...
        // Test demo credentials (PRO & FREE)
  ...
  secret: process.env.AUTH_SECRET || (process.env.NODE_ENV === 'production' ? undefined : 'f1-telemetry-nextauth-secret-key-2026-padoroku-dev'),
  trustHost: true,
});
