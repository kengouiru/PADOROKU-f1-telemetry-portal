...
export const BriefingSettingHelpModal: React.FC<BriefingSettingHelpModalProps> = ({
  ...
  > = {
    ...
    race_distance: {
      title: 'レース距離とレギュレーションモード',
      category: 'RACE LENGTH & TIRE DEGRADATION SCALING',
      icon: '🏁',
      headline: 'プレイスタイルに合わせてレースの周回数とシミュレーションのリアルさを選択できます。',
      points: [
        {
          label: '🏁 短縮グランプリ (25%距離・オススメ)',
          text: '周回数は約14〜18周（5〜8分）。タイヤ摩耗が3.2倍にスケーリングされ、短時間で「タイヤクリフ」「アンダーカットの駆け引き」「2種ドライタイヤ義務」の醍醐味が凝縮されています。',
          color: 'text-red-400',
        },
        {
          label: '🏆 フルグランプリ (100%距離・本格派)',
          text: 'F1公式のフル距離（50〜78周）。1.0倍のリアル摩耗、100kgの燃料消費による車重変化（毎周約-0.033秒速くなる）を完全計算。5x/10xの倍速再生と自動ポーズを駆使して戦います。',
          color: 'text-purple-400',
        },
        {
          label: '⚡ スプリントレース (接近戦)',
          text: '周回数は15〜19周。ピットストップ義務なし。全車フラットアウトで走るため、タイヤ温存とDRSトレインの維持・防衛が勝敗を分ける超接近バトルです。',
          color: 'text-amber-400',
        },
      ],
      regulationNote: '短縮GPおよびフルGPでは、FIA公式規則に従い「2種類以上のドライタイヤ使用義務」を満たすピット戦略が必須となります。',
    },
    ai_difficulty: {
