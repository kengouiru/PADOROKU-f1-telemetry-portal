...
export const ALL_FEATURES: FeatureItem[] = [
  // ── 注目新機能 (レビュー対象) ──
  {
    id: '2026_regulations',
    category: 'new',
    title: '2026年次世代規定シミュレーター＆図解ラボ',
    badge: '注目 No.1 / 新規定',
    badgeColor: 'bg-red-600/30 text-red-300 border-red-500/40',
    icon: '🚀',
    summary: '2026年導入のアクティブ空力（Z/Xモード）、50:50 次世代PU、マニュアルオーバーライド（MOM）、車体小型化（-30kg/-200mm）をSVGアニメーションと物理数値で動的に体感できるシミュレーター。',
    reviewPoints: [
      '【Z/Xモード切替】フラップ角度変化・ドラッグ-55%・直線最高速+25km/hのアニメーション',
      '【次世代PU】エンジンと350kW MGU-Kの50:50出力配分バー、1周8.5MJ回生量',
      '【MOMオーバーライド】時速290km/hから337km/hへ伸びる電力テーパー曲線と1000m加速差',
      '【車体小型化】現行規定マシンとのオーバーレイ寸法比較（全幅-100mm、ホイールベース-200mm）',
    ],
    locationHint: 'F1大百科 ➔ 規定・用語集 ➔ 規定・ルール最上部',
    actionText: '2026新規定ラボを開く',
  },
  {
    id: 'telemetry_delta',
    category: 'new',
