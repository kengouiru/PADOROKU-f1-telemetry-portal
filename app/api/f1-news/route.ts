...
const TEAM_CONFIGS: Record<string, { color: string; bgColor: string; borderColor: string; keywords: string[] }> = {
  'Red Bull': {
    ...
    keywords: ['red bull', 'verstappen', 'perez', 'horner', 'marko', 'lambiase', 'レッドブル'],
  },
  'Ferrari': {
    color: '#f87171',
    bgColor: 'rgba(248, 113, 113, 0.15)',
    borderColor: 'rgba(248, 113, 113, 0.4)',
    keywords: ['ferrari', 'leclerc', 'sainz', 'vasseur', 'フェラーリ', 'ルクレール', 'サインツ'],
  },
  'McLaren': {
    color: '#fb923c',
  ...
  'Mercedes': {
    ...
    keywords: ['mercedes', 'hamilton', 'russell', 'wolff', 'antonelli', 'メルセデス', 'ハミルトン', 'ラッセル'],
  },
  'Aston Martin': {
    color: '#34d399',
    bgColor: 'rgba(52, 211, 153, 0.15)',
    borderColor: 'rgba(52, 211, 153, 0.4)',
    keywords: ['aston martin', 'alonso', 'stroll', 'newey', 'アストンマーティン', 'アロンソ'],
  },
  'RB': {
    color: '#60a5fa',
    bgColor: 'rgba(96, 165, 250, 0.15)',
    borderColor: 'rgba(96, 165, 250, 0.4)',
    keywords: ['racing bulls', ' rb ', 'tsunoda', 'ricciardo', 'lawson', '角田', 'リカルド', 'ローソン'],
  },
  'Alpine': {
    color: '#0284c7',
    bgColor: 'rgba(2, 132, 199, 0.15)',
    borderColor: 'rgba(2, 132, 199, 0.4)',
    keywords: ['alpine', 'gasly', 'ocon', 'doohan', 'アルピーヌ', 'ガスリー', 'オコン'],
  },
  'Williams': {
    color: '#38bdf8',
    bgColor: 'rgba(56, 189, 248, 0.15)',
    borderColor: 'rgba(56, 189, 248, 0.4)',
    keywords: ['williams', 'albon', 'colapinto', 'sainz', 'vowles', 'ウィリアムズ', 'アルボン'],
  },
  'Sauber': {
    color: '#4ade80',
    bgColor: 'rgba(74, 222, 128, 0.15)',
    borderColor: 'rgba(74, 222, 128, 0.4)',
    keywords: ['sauber', 'kick', 'bottas', 'zhou', 'audi', 'hulkenberg', 'ザウバー', 'ボッタス'],
  },
  'Haas': {
    color: '#e2e8f0',
    bgColor: 'rgba(226, 232, 240, 0.15)',
    borderColor: 'rgba(226, 232, 240, 0.4)',
    keywords: ['haas', 'magnussen', 'bearman', 'hulkenberg', 'komatsu', 'ハース', '小松'],
  },
};
...
const DRIVER_MAP: Record<string, string[]> = {
  ...
  'RIC': ['ricciardo', 'daniel ricciardo', 'リカルド'],
